...
* Mon Aug 24 2026 Milan Crha <mcrha@redhat.com> - 2.89.4-1
- Update to 2.89.4

* Thu Jul 30 2026 Jan Grulich <jgrulich@redhat.com> - 2.89.3-1
- Update to 2.89.3

* Wed Jul 29 2026 Yanko Kaneti <yaneti@declera.com> - 2.89.2-3
- Increase test timeouts for slower hardware

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.89.2-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Wed Jul 15 2026 Vitezslav Humpa <vhumpa@redhat.com> - 2.89.2-1
- Update to 2.89.2

* Mon Jun 29 2026 Milan Crha <mcrha@redhat.com> - 2.89.1-1
- Update to 2.89.1

* Tue May 26 2026 nmontero <nmontero@redhat.com> - 2.89.0-1
- Update to 2.89.0

* Mon May 04 2026 Marek Kasik <mkasik@redhat.com> - 2.88.1-1
- Update to 2.88.1

* Wed Mar 25 2026 Jan Grulich <jgrulich@redhat.com> - 2.88.0-3
- Add configuration for release-monitoring

* Mon Mar 16 2026 Milan Crha <mcrha@redhat.com> - 2.88.0-1
- Update to 2.88.0

* Fri Mar 13 2026 Milan Crha <mcrha@redhat.com> - 2.87.5-1
- Update to 2.87.5

* Mon Mar 02 2026 Jan Grulich <jgrulich@redhat.com> - 2.87.3-2
- Packit: drop upstream_project_url and rely on release-monitoring only

* Fri Feb 27 2026 Jan Grulich <jgrulich@redhat.com> - 2.87.3-1
- Update to 2.87.3

* Wed Feb 25 2026 Jan Grulich <jgrulich@redhat.com> - 2.87.2-4
- Packit: drop fast_forward_merge_into as current stable branches diverge

* Tue Feb 24 2026 Jan Grulich <jgrulich@redhat.com> - 2.87.2-3
- Onboard to Packit for stable Fedora branches

* Mon Feb 09 2026 Jan Grulich <jgrulich@redhat.com> - 2.87.2-2
- Fix girepository test for big endian systems

* Mon Feb 09 2026 Jan Grulich <jgrulich@redhat.com> - 2.87.2-1
- Update to 2.87.2

* Mon Jan 19 2026 Jan Horak <jhorak@redhat.com> - 2.87.1-1
- Update to 2.87.1

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.87.0-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Wed Jan 07 2026 Yaakov Selkowitz <yselkowi@redhat.com> - 2.87.0-3
- Drop libatomic-static dependency

* Mon Nov 10 2025 Debarshi Ray <rishi@fedoraproject.org> - 2.87.0-1
- Update to 2.87.0
